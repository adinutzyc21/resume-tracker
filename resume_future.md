...
- Built an AI-powered system that parses spreadsheets, constructs dependency graphs, and explains model behavior using LLM-based reasoning  
- Implemented agentic workflows to analyze relationships between variables and answer what-if scenarios  
- Developed structured evaluation to validate correctness of generated insights and reasoning outputs  
